...
proc execTest(test: string) =
  when getEnv("GITHUB_ACTIONS", "false") != "true":
    ...
    execCmd "nim c   -f -d:git2Git -d:git2SetVer=\"v1.0.1\"             -r " & test
    execCmd "nim c   -f -d:git2JBB -d:git2SetVer=\"1.0.1\"  -d:danger  -r " & test
    #execCmd "nim c   -f -d:git2Static -d:git2Git -d:git2SetVer=\"v1.0.1\"  -d:danger  -r " & test
    execCmd "nim cpp -f -d:git2Git -d:git2SetVer=\"v1.0.1\"             -r " & test
    execCmd "nim cpp -f -d:git2JBB -d:git2SetVer=\"1.0.1\"  -d:danger  -r " & test
    #execCmd "nim cpp -f -d:git2Static -d:git2Git -d:git2SetVer=\"v1.0.1\"  -d:danger  -r " & test
    when (NimMajor, NimMinor) >= (1, 2):
      execCmd "nim c   -f -d:git2Git -d:git2SetVer=\"v1.0.1\" --gc:arc -r " & test
      execCmd "nim c   -f -d:git2JBB -d:git2SetVer=\"1.0.1\" -d:danger --gc:arc -r " & test
