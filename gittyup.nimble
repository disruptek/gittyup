...
proc execTest(test: string) =
  execCmd "nim cpp   -d:git2Git -d:git2SetVer=\"v1.0.0\"             -r " & test
  execCmd "nim cpp   -d:git2Git -d:git2SetVer=\"v1.0.0\"  -d:release -r " & test
  execCmd "nim cpp   -d:git2Git -d:git2SetVer=\"v1.0.0\"  -d:danger  -r " & test
  #execCmd "nim cpp -d:git2Git -d:git2SetVer=\"v1.0.0\"  -d:danger  -r " & test
  when NimMajor >= 1 and NimMinor >= 1:
    execCmd "nim cpp   -d:git2Git -d:git2SetVer=\"v1.0.0\" --gc:arc -r " & test
